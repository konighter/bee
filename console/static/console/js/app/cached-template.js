...
angular.module("cached_temp", []).run(["$templateCache",
	function(e) {
        ...
        e.put("get_interview.html",'<div class="pop_box"><div class="pop_box_header"><h3>预约面试</h3><div class="closet" ng-click="pop_box_close()">X</div></div><div class="pop_box_body"> <div class="title">候选人: {$ entry.candidate $}</div><div class="ui form "> <div class="field">  <input placeholder="面试时间" type="text"></div><div class="field"> <input placeholder="联系人" type="text"></div> <div class="field"> <textarea placeholder="备注"></textarea>  </div>  </div> </div> <div class="pop_box_action"> <div class="ui small buttons"> <div class="ui  primary button" ng-click="book_interview(entry)">提交</div> <div class="ui secondary button" ng-click="pop_box_close()">取消</div> </div> </div></div>')
